...
export class ASTParser {
    ...
    private buildLayoutTree(
        containerElement: TSESTree.JSXElement
    ): LayoutTree | null {
    ...
    private buildSplitNode(element: TSESTree.JSXElement): LayoutNode | null {
        ...
        const direction = this.getPropValue(
            props,
            'direction'
        ) as DndSplitDirection;
