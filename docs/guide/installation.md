...
```tsx
import { useDebounce, useThrottle } from 'zerojin'
```
...
```tsx
// hooks 모듈에서 import
import { useDebounce } from 'zerojin/hooks'
...
const handleSearch = zerojin.useDebounce(callback, 500)
```
...
- **useDebounce**: ~1.2KB (minified + gzipped)
...
console.log(typeof useDebounce) // 'function'
```

## 다음 단계

- [시작하기](/guide/getting-started) - 기본 사용법 학습
- [useDebounce API](/api/hooks/useDebounce) - 전체 API 문서
